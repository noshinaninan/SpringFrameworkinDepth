package com.noshinaninan.SpringFrameworkinDepth.aspect;
...
public class CountingAspect {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger("LIL Application Counter");//LIL - Linkedin Learning
